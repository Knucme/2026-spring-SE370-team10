 ...
 * - GET /api/orders/{id} (single order + access control)
 */
...
class OrderControllerTest {
    ...
    // Helper to simulate a logged-in user in tests
    ...
    @Test
    void getOrderById_fohCannotSeeOtherUsersOrder() throws Exception {
        // Order belongs to user 99, FOH user is 3 — should be blocked
